...
/**
 * Base Activity that contains code common to the general vertretungsplan
 * activity and the my vertretungsplan activity.
 */
public class BaseVertretungsplanActivity extends BaseActivity {
